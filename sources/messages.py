...
def back_to_main_menu_msg(username: str) -> str:
    msg = f'{username}, действие ❌<b>было отменено</b>❌!\n' \
...
def what_desire_delete() -> str:
    return "Какое желание необходимо <b>удалить</b>🗑?"


def confirmed_delete_desire() -> str:
    return "Вы уверены, что хотите <b>удалить</b> данное желание?"


def delete_desire(name_desire: str) -> str:
    return f'Желание <b>"{name_desire}"</b> было удалено.'
